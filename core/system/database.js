...
export const defSets = {
  ...
  nameid: 'ೃ࿔ 𝗣𝗿𝗶𝗺𝗲 𝗕𝗼𝘁 𝗣𝗿𝗼 .ೃ࿐',
  type: 'Owner',
  link: 'https://api.yuki-wabot.my.id',
  banner: 'https://fv5-5.files.fm/thumb.php?i=9czpp4k2ff&v=1&n=gohan.jpg',
  icon: 'https://fv5-5.files.fm/thumb.php?i=9czpp4k2ff&v=1&n=gohan.jpg',
  currency: 'Yenes',
  namebot: 'Prime',
  botname: 'Prime Bot ',
  owner: ''
...
export function initDB() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS settings (
      ...
      nameid TEXT DEFAULT 'ೃ࿔ 𝗣𝗿𝗶𝗺𝗲 𝗕𝗼𝘁 𝗣𝗿𝗼 .ೃ࿐',
      type TEXT DEFAULT 'Owner',
      link TEXT DEFAULT 'https://api.yuki-wabot.my.id',
      banner TEXT DEFAULT 'https://fv5-5.files.fm/thumb.php?i=9czpp4k2ff&v=1&n=gohan.jpg',
      icon TEXT DEFAULT 'https://fv5-5.files.fm/thumb.php?i=9czpp4k2ff&v=1&n=gohan.jpg',
      currency TEXT DEFAULT 'Yenes',
      namebot TEXT DEFAULT 'Yuki',
      botname TEXT DEFAULT 'Prime Bot ',
      owner TEXT DEFAULT ''
    )`);
