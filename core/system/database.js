...
export const defSets = {
  ...
  banner: 'https://cdn.adoolab.xyz/dl/b64d9115.jpg',
  icon: 'https://cdn.adoolab.xyz/dl/b64d9115.jpg',
  currency: 'Yenes',
  namebot: 'Prime',
  botname: 'Prime Bot ',
  owner: ''
...
export function initDB() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS settings (
      ...
      banner TEXT DEFAULT 'https://cdn.adoolab.xyz/dl/b64d9115.jpg',
      icon TEXT DEFAULT 'https://cdn.adoolab.xyz/dl/b64d9115.jpg',
