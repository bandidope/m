...
export const defSets = {
  ...
  banner: 'https://files.catbox.moe/wma3yv.jpg',
  icon: 'https://files.catbox.moe/wma3yv.jpg',
  currency: 'Yenes',
  namebot: 'Prime',
  botname: 'Prime Bot ',
  owner: ''
...
export function initDB() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS settings (
      ...
      banner TEXT DEFAULT 'https://files.catbox.moe/wma3yv.jpg',
      icon TEXT DEFAULT 'https://files.catbox.moe/wma3yv.jpg',
